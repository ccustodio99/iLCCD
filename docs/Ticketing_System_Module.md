...
5. From the ticket list, the owner or assigned user can click **Job Order** or **Requisition** (visible while the ticket is unconverted). These buttons open modals to complete the conversion.
