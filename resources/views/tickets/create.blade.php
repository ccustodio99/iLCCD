...
<div class="container">
    ...
    <form action="{{ route('tickets.store') }}" method="POST" class="ticket-form">
        ...
        <div class="mb-3">
            ...
            <input id="subject" type="text" name="subject" class="form-control" value="{{ old('subject') }}" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input id="due_at" type="date" name="due_at" class="form-control" value="{{ old('due_at') }}">
        </div>
