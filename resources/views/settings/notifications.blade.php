...
<div class="container">
    ...
    <form action="{{ route('settings.notifications.update') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea id="template_ticket_updates" name="template_ticket_updates" rows="6" class="form-control">{{ setting('template_ticket_updates', $placeholder) }}</textarea>
        </div>
        <div class="form-check form-switch mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea id="template_job_order_status" name="template_job_order_status" rows="6" class="form-control">{{ setting('template_job_order_status', $placeholder) }}</textarea>
        </div>
        <div class="form-check form-switch mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea id="template_requisition_status" name="template_requisition_status" rows="6" class="form-control">{{ setting('template_requisition_status', $placeholder) }}</textarea>
        </div>
        <div class="form-check form-switch mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea id="template_low_stock" name="template_low_stock" rows="6" class="form-control">{{ setting('template_low_stock', $placeholder) }}</textarea>
        </div>
