<div class="modal fade" id="documentCategoriesModal" tabindex="-1" aria-labelledby="documentCategoriesModalLabel" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="documentCategoriesModalLabel" class="modal-title">Document Categories</h5>
...
<?php /**PATH D:\SynologyDrive\MIT Studies\xampp\htdocs\iLCCD\resources\views/settings/document-categories/modal-index.blade.php ENDPATH**/ ?>